const products = [
  {
    ...
    category: "Fruit",
    description:
      "A round fruit with a red, green, or yellow, and you can enjoy with eating it ",
    price: 89,
    rating: 5,
    discount: 0,
    images: [
  ...
  },
  {
    ...
    category: "Bakery",
    description:
      "A staple food made from flour, water, and yeast, baked into a loaf, and you can enjoy.",
    price: 88,
    rating: 5,
    discount: 20,
    images: [
  ...
  },
  {
    ...
    category: "Vegetable",
    description:
      "A root vegetable with a crunchy texture and a sweet, and earthy flavor.",
    price: 82,
    rating: 5,
    discount: 20,
    images: [
  ...
  },
  {
    ...
    category: "Meat",
    description:
      "A type of poultry, often used as a source of protein in meals,, and you can enjoy with eating it.",
    price: 68,
    rating: 3.5,
    discount: 20,
    images: [
...
products.map((product) => {
  str += `     <div class="home-card">
  <div class="product-img">
    <div class="loved">
      <img src="../assets/images/image17.svg" alt="" />
    </div>
    <img src="${product.images[0]}" alt="" style="width:272px"/>
  </div>
  <div class="card-btom">
    <div class="d2">
      <p class="p2" id="p2">${product.price},00₽</p>
    </div>
